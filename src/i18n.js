...
const messages = {
  de: {
    ...
    settings: {
      ...
      animationsHint: 'Schalte Animationen aus, wenn das Spiel auf deinem Gerät ruckelt.',
    ...
    leaderboard: {
      ...
      subtitleMerge: 'Höchstes Tier, dann Punkte und Fusionen.',
      bossStage: 'Etappe',
      bossVictories: 'Siege',
      mergeHighestTile: 'Höchstes Tier',
      mergeScore: 'Punkte',
      mergeFusions: 'Fusionen',
      you: 'Du',
  ...
  en: {
    ...
    settings: {
      ...
      animationsHint: 'Turn animations off if the game stutters on your device.',
    ...
    leaderboard: {
      ...
      subtitleMerge: 'Highest animal, then score and merges.',
      bossStage: 'Stage',
      bossVictories: 'Victories',
      mergeHighestTile: 'Highest animal',
      mergeScore: 'Score',
      mergeFusions: 'Merges',
      you: 'You',
      retry: 'Try again',
  ...
  ru: {
    ...
    leaderboard: {
      ...
      endlessDamage: 'Урон',
      subtitleMerge: 'Высшее животное, затем очки и слияния.',
      bossStage: 'Этап',
      bossVictories: 'Победы',
      mergeHighestTile: 'Высшее животное',
      mergeScore: 'Очки',
      mergeFusions: 'Слияния',
      you: 'Ты',
