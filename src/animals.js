...
// Re-export pure utilities from the dependency-free coinUtils module
// so existing callers (import { formatCoins } from './animals') continue to work.
export { formatCoins, parseCoinInput } from './coinUtils'
