...
const I18N = {
  ...
  ru: {
    ...
    labels: {
      ...
      accept: 'Принять',
      confirmAccept: 'Подтвердить обмен',
      decline: 'Отклонить',
      cancel: 'Отозвать',
      from: 'От',
      to: 'Кому',
      ...
      wantedAnimals: 'Желаемые животные',
      wantedAnyAnimals: 'Любые животные опционально',
      confirmPublicTitle: 'Принять обмен?',
      youGet: 'Вы получаете',
      youGive: 'Вы отдаете',
    ...
    hints: {
      ...
      publicCoinsOnly: 'Запрашивайте монеты или желаемых животных в качестве оплаты.',
      searching: 'Поиск...',
    ...
    errors: {
      ...
      publicWantedIncomplete: 'Выберите желаемых животных.',
      publicWantedNotMet: 'Выберите именно запрошенных животных для этого публичного обмена.',
